...
class WC_Gateway_PPEC_Cart_Handler {
	...
	public function display_paypal_button_product() {
		...
		<div class="wcppec-checkout-buttons woo_pp_cart_buttons_div">
			...
			<a href="<?php echo esc_url( add_query_arg( array( 'startcheckout' => 'true' ), wc_get_page_permalink( 'cart' ) ) ); ?>" id="woo_pp_ec_button_product" class="wcppec-checkout-buttons__button">
				<img src="<?php echo esc_url( $express_checkout_img_url ); ?>" alt="<?php _e( 'Check out with PayPal', 'woocommerce-for-japan' ); ?>" style="width: auto; height: auto;">
			</a>
			<?php endif; ?>
		</div>
		<?php
	...
	public function display_paypal_button() {
		...
		<div class="wcppec-checkout-buttons woo_pp_cart_buttons_div">
			...
			<?php if ( $settings->is_credit_enabled() ) : ?>
				...
				<img src="<?php echo esc_url( $paypal_credit_img_url ); ?>" alt="<?php _e( 'Pay with PayPal Credit', 'woocommerce-for-japan' ); ?>" style="width: auto; height: auto;">
				</a>
			<?php endif; ?>
	...
	public function display_mini_paypal_button() {
		...
		<a href="<?php echo esc_url( add_query_arg( array( 'startcheckout' => 'true' ), wc_get_page_permalink( 'cart' ) ) ); ?>" id="woo_pp_ec_button" class="wcppec-cart-widget-button">
			<img src="<?php echo esc_url( 'https://www.paypalobjects.com/webstatic/en_US/i/btn/png/gold-rect-paypalcheckout-26px.png' ); ?>" alt="<?php _e( 'Check out with PayPal', 'woocommerce-for-japan' ); ?>" style="width: auto; height: auto;">
		</a>
		<?php endif; ?>
		<?php
	}
