...
class JP4WC{
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_paypal_args',array( &$this,  'jp4wc_paypal_bn'));
    ...
    protected function define_constants() {
        ...
        $this->define( 'WC_PAIDY_VERSION', $this->version );
        $this->define( 'WC_PAIDY_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
    }
	...
	private function includes() {
        ...
        require_once JP4WC_ABSPATH.'includes/class-jp4wc-admin-screen.php';
	...
	/**
	 * Set PayPal bn for Artisan Workshop.
     *
     * @since  1.2
     * @version 2.0.0
     * @param  array $fields
     * @return array
	 */
	public function jp4wc_paypal_bn( $fields ) {
